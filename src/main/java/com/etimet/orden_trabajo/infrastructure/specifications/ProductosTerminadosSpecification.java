...
public class ProductosTerminadosSpecification {

    public static Specification<ProductosTerminados> busquedaGlobal(String termino, List<String> camposDeTexto) {
            ...
            for (String campo : camposDeTexto) {
                if (campo.contains(".")) {
                    ...
                    predicados.add(criteriaBuilder.like(
                            criteriaBuilder.lower(joinTabla.get(partes[1])),
                            patronBusqueda));
                } else {
                    predicados.add(criteriaBuilder.like(
    ...
    public static Specification<ProductosTerminados> activos() {
        return (root, query, cb) -> cb.isTrue(root.get("estadoProductoTerminado"));
    }
}
